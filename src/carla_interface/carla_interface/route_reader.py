...
class RouteReaderNode(Node):
    ...
    def __init__(self):
        ...
        route_file_paths = {
            "town02": "/carla_interface/data/routes_town02.xml",
            "town02_turn": "/carla_interface/data/routes_town02_turn.xml",
            "town02_straight": "/carla_interface/data/routes_town02_straight.xml",
            "town03": "/carla_interface/data/routes_town03.xml",
        }
        route_file_path = route_file_paths["town03"]
        tree = ET.parse(route_file_path)
        self.get_logger().info(f"Loaded Carla route file from {route_file_path}")
